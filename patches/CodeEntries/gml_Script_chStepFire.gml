...
var fired = (kFire && kFirePushedSteps == 0) || (firebuttons && global.opmslstyle == 2);
var beamfire = kFire && kFirePushedSteps == 0 && global.opmslstyle == 2;
if (fired && nofire == 0 && turning == 0 && morphing == 0 && unmorphing == 0 && walljumping == 0 && !instance_exists(oEMPNoise))
{
    nofire = 6;
    idle = 0;
    chStepSetSprite();
...
if (kFire && kFirePushedSteps > 15 && chargebeam < 1 && nofire == 0 && sjball == 0 && state != SJSTART && state != SUPERJUMP && state != SJEND && global.cbeam == 1 && !instance_exists(oEMPNoise))
{
    chargebeam += 0.02;
}
if (chargebeam > 0)
