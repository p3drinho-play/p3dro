...
if (global.proc_active && global.proc_speed_mult > 1)
{
    xVel *= global.proc_speed_mult;
}
...
if (monster_drain > 0)
{
    ...
    if (!reformIFrames)
    {
        ...
        {
            global.playerhealth -= (0.5 * (global.mod_monstersdrainPS * oControl.mod_diffmult));
        }
        else if (global.currentsuit == 0 && oControl.mod_monstersextreme != 0)
        {
            global.playerhealth -= (0.5 * (global.mod_monstersdrainPS * 4));
        }
        if (global.currentsuit == 1 && oControl.mod_monstersextreme == 0)
        {
            global.playerhealth -= (0.5 * (global.mod_monstersdrainVS * oControl.mod_diffmult));
        }
        else if (global.currentsuit == 1 && oControl.mod_monstersextreme != 0)
        {
            global.playerhealth -= (0.5 * (global.mod_monstersdrainVS * 4));
        }
        if (global.currentsuit == 2 && oControl.mod_monstersextreme == 0)
        {
            ...
            {
                global.playerhealth -= (0.5 * (global.mod_monstersdrainGS * oControl.mod_diffmult));
            }
        }
        else if (global.currentsuit == 2 && oControl.mod_monstersextreme != 0)
        {
            ...
            {
                global.playerhealth -= (0.5 * (global.mod_monstersdrainGS * 4));
            }
        }
        if (global.sax)
        {
            if (global.currentsuit == 0 && oControl.mod_monstersextreme == 0)
            {
                global.playerhealth -= (0.5 * (global.mod_monstersdrainPS * 2));
            }
            else if (global.currentsuit == 0 && oControl.mod_monstersextreme != 0)
            {
                global.playerhealth -= (0.5 * (global.mod_monstersdrainPS * 4));
            ...
            if (global.currentsuit == 1 && oControl.mod_monstersextreme == 0)
            {
                global.playerhealth -= (0.5 * (global.mod_monstersdrainVS * 2));
            }
            else if (global.currentsuit == 1 && oControl.mod_monstersextreme != 0)
            {
                global.playerhealth -= (0.5 * (global.mod_monstersdrainVS * 4));
            ...
            if (global.currentsuit == 2 && oControl.mod_monstersextreme == 0)
            {
                ...
                {
                    global.playerhealth -= (0.5 * (global.mod_monstersdrainGS * 2));
                }
            }
            else if (global.currentsuit == 2 && oControl.mod_monstersextreme != 0)
            {
